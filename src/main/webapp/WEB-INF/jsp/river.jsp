...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/riverStyle.css">
</head>
<body>
<div class="container">
    ...
    <div class="button-container">
        <button class="continue-btn"
                onclick="window.location.href='${pageContext.request.contextPath}/success'">
            ${rightAnswer}
        </button>
        <button class="continue-btn"
